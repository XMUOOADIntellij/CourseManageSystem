...
public class SeminarController {
    ...
    public SeminarVO selectKlassSeminarBySeminarIdAndClassId(@PathVariable Long seminarId, @PathVariable Long classId) {
        ...
        if (record == null) {
            throw new RecordNotFoundException("未找到班级讨论课");
        } else {
    ...
    public AttendanceVO getTeamAttendance(@PathVariable Long seminarId, @PathVariable Long classId,
        ...
        Attendance attendance = attendanceService.getTeamAttendance(seminarId, classId, student);

        if (attendance == null) {
            return null;
        } else {
            return new AttendanceVO(attendance);
        }
