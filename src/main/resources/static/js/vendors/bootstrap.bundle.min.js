  ...
  var pe,
    ...
    (Be = (function() {
      ...
      return (
        ...
        (e._getConfig = function(t) {
          return (
            (t = r({}, this.constructor.Default, pe(this._element).data(), t)),
          ...
          n.hasClass(Xn)
            ...
            : (n.addClass(Jn),
              ...
              n
                ...
                .addClass(Jn)),
            Bn(this._scrollElement).trigger(zn.ACTIVATE, { relatedTarget: t });
        }),
        (e._clear = function() {
          Bn(this._selector)
            .filter(Zn.ACTIVE)
