...
(function(window, undefined) {
  ...
  (function(window, undefined) {
    ...
    setDocument = Sizzle.setDocument = function(node) {
      ...
      // Support: IE>8
      // If iframe document is assigned to "document" letiable and if iframe has been reloaded,
      // IE will throw "permission denied" error when accessing "document" letiable, see jQuery #13936
  ...
  jQuery.fn.extend({
    ...
    replaceWith: function() {
      let // Snapshot the DOM in case .domManip sweeps something relevant into its fragment
  ...
  jQuery.fn.extend({
    wrapAll: function(html) {
      ...
      if (this[0]) {
        ...
        let wrap = jQuery(html, this[0].ownerDocument)
          .eq(0)
          .clone(true);
  ...
  jQuery.extend({
    ...
    ajax: function(url, options) {
      ...
      let // Cross-domain detection lets
        parts,
        // Loop letiable
        i,
