...
function getSeminarList(roundId) {
  $.ajax({
    type: "get",
    url: "http://xug98.cn/round/" + "1" + "/seminar",
    dataType: "json",
    contentType: "application/json;",
    success: function(data, textStatus, xhr) {
      if (xhr.status === 200) {
...
function getSeminarScoreByClass() {
  ...
  $.ajax({
    type: "get",
    url: "http://xug98.cn/score/seminar/" +
      Cookies.get("seminar") +
      "/class/" +
      Cookies.get("class") +
      "/score",
...
function getRoundScoreByCourse(cid) {
  ...
  $.ajax({
    type: "get",
    url: "http://xug98.cn/score/course/" + Cookies.get("course") + "/score",
    dataType: "json",
    contentType: "application/json;",
    success: function(data, textStatus, xhr) {
      if (xhr.status === 200) {
...
function updatePresentScoreByTeam() {
  ...
  $.ajax({
    type: "put",
    url: "http://xug98.cn/attendance/" + Cookies.get("attendance") + "/score",
    dataType: "json",
    data: JSON.stringify(ata),
...
function getAttendanceScore() {
  ...
  $.ajax({
    type: "get",
    url: "http://xug98.cn/score/attendance/" +
      Cookies.get("attendance") +
      "/score",
    dataType: "json",
    contentType: "application/json",
